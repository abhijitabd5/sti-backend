...
export const ERROR_MESSAGES = {
  ...
  WEAK_PASSWORD: 'Password must be at least 8 characters long with uppercase, lowercase, number and special character',
  ...
  EXPENSE_CATEGORY_IN_USE: 'Cannot delete expense category as it has linked expenses',
